...
<body>
    <section>
        ...
        <main class="conteneur-principal conteneur-1280">
            ...
            <p><h2 class="chapo"> <?php echo $article["chapo"]; ?></h2></p>
            <p><h3 class="paragraphe"> <?php echo $article["contenu"]; ?> </p>

            <img class="image-art"  height="400"  src="<?php echo $article["image"]; ?>" alt="image "> <br>

            <p class="date_derniere_mise_a_jour"> <?php echo $article["date_derniere_mise_a_jour"]; ?> </p> <br>

            <p class="lien_yt"> <?php echo $article["lien_yt"]; ?> </p> <br>
